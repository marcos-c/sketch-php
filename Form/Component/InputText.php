...
/**
 * SketchFormComponentInputText
 *
 * @package Components
 */
class SketchFormComponentInputText extends SketchFormComponent {
    function saveHTML() {
        ...
        if ($field_value == null && $default != null) {
            $ignore_parameters = (($parameters != null && strpos(" $parameters", 'class="')) ? $parameters : implode(' ', array($parameters, 'class="input-text-disabled"')));
