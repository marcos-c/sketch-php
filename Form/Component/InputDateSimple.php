...
/**
 * SketchFormComponentInputDateSimple
 *
 * @package Components
 */
class SketchFormComponentInputDateSimple extends SketchFormComponent {
    ...
    function javascript() {
        ...
        function <?=$form_name?>UpdateDate(input, date, calendar_input) {
            ...
            var monthNames = ['<?=$this->getTranslator()->_('Jan')?>', '<?=$this->getTranslator()->_('Feb')?>', '<?=$this->getTranslator()->_('Mar')?>', '<?=$this->getTranslator()->_('Apr')?>', '<?=$this->getTranslator()->_('May')?>', '<?=$this->getTranslator()->_('Jun')?>', '<?=$this->getTranslator()->_('Jul')?>', '<?=$this->getTranslator()->_('Aug')?>', '<?=$this->getTranslator()->_('Sep')?>', '<?=$this->getTranslator()->_('Oct')?>', '<?=$this->getTranslator()->_('Nov')?>', '<?=$this->getTranslator()->_('Dec')?>'];
