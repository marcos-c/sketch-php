...
/**
 * SketchFormComponentInputTextArea
 *
 * @package Components
 */
class SketchFormComponentInputTextArea extends SketchFormComponent {
    function saveHTML() {
        ...
        return '<textarea id="'.$field_name.'" name="'.$field_name.'" '.$parameters.'>'.$field_value.'</textarea>';
    }
}