...
namespace Sketch\HTTP\Response;

use Sketch\Core\DateTime;
use Sketch\Form\Form;
use Sketch\Locale\LocaleISO;
use Sketch\Core\Object;

/**
 * HTTP response part
 *
 * @package Sketch\HTTP\Response
 */
class Part extends Object {
    ...
    static function evaluate($file_name, $etag = false, $attributes = array(), $update_include_path = false) {
        $part = new Part($file_name, $etag, $attributes, $update_include_path);
    ...
    /**
     * @param \Sketch\Core\DateTime $date
     * @return string
     */
