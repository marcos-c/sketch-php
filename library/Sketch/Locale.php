...
class Locale extends Object {
    ...
    function getTranslator($reference = 'default') {
        if ($this->translator == null) {
            ...
            foreach ($drivers as $driver) {
                ...
                try {
                    ...
                    $this->translator[$ref] = new LocaleTranslator(new LocaleTranslatorDriverMock());
                }
            }
        }
        if (array_key_exists($reference, $this->translator)) {
            ...
            return new LocaleTranslator(new LocaleTranslatorDriverMock());
        }
    }
    ...
    function getFormatter() {
        return new LocaleFormatter($this->toString());
    }
}