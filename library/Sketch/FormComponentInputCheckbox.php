...
class FormComponentInputCheckbox extends FormComponent {
    function saveHTML() {
        ...
        return '<input type="checkbox" id="'.$field_name.'" name="'.$field_name.'" value="'.$true.'"'.($check ? ' checked="checked"' : '').' '.$parameters.' />';
    }
}