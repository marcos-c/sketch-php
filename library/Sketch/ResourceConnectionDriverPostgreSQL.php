...
class PostgreSQLResultSet extends ObjectIterator {
    function rows() {
...
class PostgreSQLConnectionDriver extends ConnectionDriver {
    private $connection;
    ...
    function executeQuery($expression) {
        ...
        if ($error) {
            ...
            throw new ResourceConnectionException(pg_result_error_field($result, PGSQL_DIAG_MESSAGE_PRIMARY).' '.$expression, $error);
        }
