...
use Sketch\Form\FormList;
use Sketch\Form\FormView;

/**
 * Core object list definition
 *
 * @package Sketch\Core
 */
abstract class ObjectList extends ObjectView {
    /**
     * @var string
     */
    private $orderBy;
    ...
    /**
     * @param \Sketch\Form\FormList $form
     * @param string $parameters
     * @return boolean
     */
    final function orderBy(FormList $form, $parameters) {
    ...
    /**
     * @param \Sketch\Form\FormView $form
     * @param mixed $parameters
     * @return boolean
     */
    final function setOrderByAction(FormView $form, $parameters = null) {
     ...
     * @return integer
     */
    final function offset(FormList $form, $parameters) {
     ...
     * @return boolean
     */
    final function clearOffsetAction(FormView $form) {
